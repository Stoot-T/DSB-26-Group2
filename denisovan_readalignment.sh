...
#SBATCH --time=30:00:00                        #Max. runtime (30 hours)
#SBATCH --mem=36G                              #Total memory requested
#SBATCH --cpus-per-task=8                      # Number of CPU cores
#SBATCH -o /gpfs/home/USER/scratch/DSB-26-Group2/output_messages/download_%j.out      #-o flag captures everything printed to standard .out file %j is a slurm variable that replaces job name with id  helpful to troubleshooting code
#SBATCH -e /gpfs/home/USER/scratch/DSB-26-Group2/error_messages/download_%j.err       #-e  captures error messages and saves them to a .err file
#SBATCH --mail-type=ALL                        #Receive emails when the job starts, ends or fails 
#SBATCH --mail-user=USER@uea.ac.uk
...
rawdata="/gpfs/home/USER/scratch/DSB-26-Group2/data/raw"
reference="/gpfs/home/USER/scratch/DSB-26-Group2/data/reference"
mappedsam="/gpfs/home/USER/scratch/DSB-26-Group2/mapped_sam"
mappedbam="/gpfs/home/USER/scratch/DSB-26-Group2/mapped_bam"
sortedfiles="/gpfs/home/USER/scratch/DSB-26-Group2/sorted_files"
txtout="/gpfs/home/USER/scratch/DSB-26-Group2/txt_output"
